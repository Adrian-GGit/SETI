...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{img/metrics-acc-recall-prec.png}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{img/metrics-avgloss-rocauc.png}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{img/lernrates-vs.png}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{img/lernrate-scheduler.png}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{img/folds.png}
\end{figure}
